  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href='{{ url('show') }}'><i class="fa fa-link"></i> <span>Tickets</span></a></li>
        <li class="active"><a href='{{ url('bookings') }}'><i class="fa fa-link"></i> <span>Service Bookings</span></a></li>
